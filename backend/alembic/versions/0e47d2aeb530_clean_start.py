...
Revision ID: 0e47d2aeb530
Revises: 5077d1f0ca7d
Create Date: 2026-04-11 14:42:27.127936
...
revision: str = '0e47d2aeb530'
down_revision: Union[str, Sequence[str], None] = '5077d1f0ca7d'
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('PATIENT', 'DOCTOR', 'PHARMACY', 'LAB', 'ADMIN', name='userrole'), nullable=True),
    ...
    sa.Column('payment_status', sa.Enum('PENDING', 'SUCCESS', 'FAILED', 'REFUNDED', 'PARTIALLY_REFUNDED', name='paymentstatus'), nullable=True),
    ...
    sa.Column('is_verified', sa.Boolean(), nullable=True),
    sa.Column('wallet_balance', sa.DECIMAL(precision=10, scale=2), nullable=True),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
